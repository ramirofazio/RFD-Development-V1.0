export const experienceData = [
    ...
    {
        name: "Calculator",
        description: "This is a simple calculator with a simple UI.",
        link: "https://github.com/ramirofazio/Calculator",
        usedTechnologies: ["Javascript", "HTML", "CSS"],
    },
    {
        name: "Ada School Plataform",
        description: "Colaborate with a group of developers to automate the take of attendance of the students, and develop the user profile page so they can chenge their information.",
        link: "https://learn.ada-school.org/",
        usedTechnologies: ["Javascript", "React", "GraphQL", "MongoDB"],
    },
    {
        name: "Resto Book",
